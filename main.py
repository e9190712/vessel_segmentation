...
parser.add_argument("--k_fold", default=2, type=int, help='fold num, None is not k_fold')
parser.add_argument("--epoch", default=100, type=float, help='number of passes of the entire training dataset the machine learning algorithm has completed')
...
parser.add_argument("--backbone", default='senet154', type=str, help="inceptionresnetv2, densenet121, VGG16, densenet201, senet154, resnext50, resnext101")#選擇backbone
parser.add_argument("--load_npz_path", default='/media/NAS/mike2/npz_dataset/dataset_5_fold_NoAug(gray)/set.npz', type=str, help='CAG set')#load訓練圖像，已經將png轉成npz，這樣load時會比較快
parser.add_argument("--save_model", default='/media/NAS/mike2/higher_score_model_and_result/Unet_with_senet154_11Aug(100_epoch)_F1_5F_model', type=str, help='path of save model')
parser.add_argument("--load_model", default='/media/NAS/mike2/higher_score_model_and_result/Unet_with_senet154_11Aug(100_epoch)_F1_5F_model', type=str, help='path of load model')
